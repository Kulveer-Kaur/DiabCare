...
<html lang="zxx">
  ...
  <!-- ** Basic Page Needs ** -->
  <meta charset="utf-8">
  <title>DiabCare | Medical HTML Template</title>
    ...
    <div class="row align-items-center">
      <div class="col-md-6">
        <div class="top-left text-center text-md-left">
          <h6>We are 24 Hours Availabe </h6>
        </div>
      </div>
      <div class="col-md-6">
          ...
          <ul class="contact-info pl-0 mb-4 mb-md-0">
            <li class="item text-left">
              ...
              <a href="mailto:info@medic.com">
                <span>yourdiabcare@gmail.com</span>
              </a>
            </li>
            <li class="item text-left">
              <div class="icon-box">
    ...
    <div class="collapse navbar-collapse" id="navbarLinks">
      <ul class="navbar-nav">
        ...
        <!--<li class="nav-item @@service">
          <a class="nav-link" href="service.php">Register</a>
        </li>-->
        ...
        <li class="nav-item @@contact">
          <a class="nav-link" href="hms/contact.html">Contact</a>
</li>
        <li class="nav-item @@contact">
