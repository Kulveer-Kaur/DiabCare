      ...
      <div class="col-lg-6 order-1 order-lg-0">
        <div class="contact-area style-two pl-0 pr-0 pr-lg-4">
          <div class="section-title">
            <h3>REGISTER<span>YOURSELF</span></h3>
          </div>
          <form name="contact_form" class="default-form contact-form" action="!#" method="post">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <input class="form-control" type="text" name="Date" placeholder="Date of Birth" required="" id="datepicker" autocomplete="off">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                <div class="form-group">
                  <input class="form-control" name="year" placeholder="First Diagonstic in which year" required=""/>
                </div>

                <h3>Other Problems Diagnosted:</h3><br>
                <div class="form-group">
                <input type="checkbox" class="specialization" id="cs" name="specialization[]" value="High Blood Pressure">High Blood Pressure
                    <input type="checkbox" class="specialization" id="it" name="specialization[]" value="Heart Disease">Heart Disease
                    <input type="checkbox" class="specialization" id="ca" name="specialization[]" value="Eye problem">Eye problem
                    <input type="checkbox" class="specialization" id="tc" name="specialization[]" value="High Cholestrol">High Cholestrol
                    <input type="checkbox" class="specialization" id="tc" name="specialization[]" value="Overweight">Overweight
                    <input type="checkbox" class="specialization" id="tc" name="specialization[]" value="Thyroid">Thyroid
                    <input type="checkbox" class="specialization" id="tc" name="specialization[]" value="Oral problem">Oral Problem
                    <input type="checkbox" class="specialization" id="tc" name="specialization[]" value="Kidney Disease">Kidney Disease
</div>

              <div class="col-md-12">
                <div class="form-group">
                  <textarea class="form-control" name="form_message" placeholder="Specify Other Problems" required=""></textarea>
                </div>
