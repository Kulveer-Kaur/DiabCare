    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="section-title text-center">
          ...
          <p>We provide you with best doctors, practitioner, endocrynologists in service
            <br>All are fully educated and experinced...</p>
        </div>
        <!-- Nav tabs -->
        <div class="tabs">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-6">
                <div class="team-person text-center">
                  <img loading="lazy" src="images/team/doctor-2.jpeg" class="img-fluid" alt="team">
                  <h6>Dr. Gurpreet</h6>
                  <p>Endocrynology Specialist</p>
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                <div class="team-person text-center">
                  <img loading="lazy" src="images/team/doctor-4.jpg" class="img-fluid" alt="team">
                  <h6>Dr. Parminder Singh</h6>
                  <p>Diabetes Specialist</p>
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                <div class="team-person text-center">
                  <img loading="lazy" src="images/team/doctor-5.png" class="img-fluid" alt="team">
                  <h6>Dr. Pramod Tripathi</h6>
                  <p>Diet Specialist</p>
                </div>
              </div>
            </div>
