...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> Diab Care</a>
          ...
          <div class="col-md-4"><label>Doctor Name:</label></div>
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="Diabetologist" name="spec">Diabetologist</option>
                      <option value="Endocrynologist" name="spec">Endocrynologist</option>
